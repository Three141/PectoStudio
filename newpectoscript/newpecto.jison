...
"עצור"                            parser.restricted = true; return "BREAK";
"במקרה"                             return "CASE";
"תפוס"                            return "CATCH";
"המשך"                         parser.restricted = true; return "CONTINUE";
"דיבאגר"                         return "DEBUGGER";
"ברירת מחדל"                          return "DEFAULT";
"מחק"                           return "DELETE";
"עשה"                               return "DO";
"אחרת"                             return "ELSE";
"לבסוף"                          return "FINALLY";
"עבור"                              return "FOR";
...
"בחירה"                           return "SWITCH";
"זה"                             parser.restricted = false; return "THIS";
"זרוק"                            parser.restricted = true; return "THROW";
"נסה"                              return "TRY";
"הסוג של"                           parser.restricted = false; return "TYPEOF";
"משתנה"                            return "VAR";
"ריק"                             parser.restricted = false; return "VOID";
"כל עוד"                            return "WHILE";
"עם"                             return "WITH";
"אמת"                             parser.restricted = false; return "TRUE";
"שקר"                            parser.restricted = false; return "FALSE";
"כלום"                             parser.restricted = false; return "NULL";
"מחלקה"                            return "CLASS";
"קבוע"                            return "CONST";
"אוגדן"                             return "ENUM";
"ייצא"                           return "EXPORT";
...
"באמת שונה מ"                              return "!==";
"שונה מ"                               return "!=";
"לא"                                parser.restricted = false; return "!";
"<<="                              return "<<=";
"<<"                               return "<<";
"קטן או שווה ל"                               return "<=";
"קטן מ"                                return "<";
">>>="                             return ">>>=";
">>>"                              return ">>>";
">>="                              return ">>=";
">>"                               return ">>";
"גדול או שווה ל"                               return ">=";
"גדול מ"                                return ">";
"הוסף"                               return "+=";
"הגדל"                               parser.restricted = false; return "++";
"ועוד"                                return "+";
"הפחת"                               return "-=";
"הקטן"                               parser.restricted = false; return "--";
"פחות"                                return "-";
"הכפל"                               return "*=";
"כפול"                                return "*";
"חלק"                               return "/=";
